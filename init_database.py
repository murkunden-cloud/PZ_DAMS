...
def create_database():
    with db_manager.get_connection() as conn:
        ...
        CREATE TABLE IF NOT EXISTS disciplinary_cases (
            ...
            report_received_date VARCHAR(100),
            scn_issued_details TEXT,
            punishment_awarded TEXT,
            appeal_details TEXT,
            suspension_start_date DATE,
            suspension_end_date VARCHAR(100),
            suspension_reason TEXT,
            export_type_of_case TEXT,
            export_suspension_details TEXT,
            export_present_status TEXT,
            export_final_order TEXT,
            export_outcome TEXT,
